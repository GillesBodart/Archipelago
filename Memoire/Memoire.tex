...
Le but de ce travail est de permettre à l'utilisateur de se centrer sur la représentation du modèle ansi qu'au traitement métier de celui-ci, plutôt que de "perdre son temps" à devoir implémenter la couche de persistance.

L'état actuel du développement de ce framework est un état de "Proof of concept".
