...
Dans ce chapitre, nous allons retracer dans un premier temps l'historique des bases de données de type NoSQL. Dans un second temps, nous aborderons les différences entre les bases de données relationnelles et les bases de données orientées graphe.Et, pour finir, nous positionnerons notre recherche au vu de ce que nous aurons appris précédemment.
...
Dans ce chapitre, nous allons vous décrire concrètement ce qu'est Archipelago. Nous vous introduirons un exemple illustratif d'utilisation des BDOG et nous parcourrons l'ensemble des fonctionnalités que permet ce framework.
...
Nous avons décidé de scinder les perspectives d'améliorations des conclusions de ce mémoire, car nous aimerions dresser un ensemble de pistes auxquelles nous avons pensés mais que nous n'avons su mettre en place. Ces éléments pourront servir de \enquote{cahier des charges} pour une deuxième version de ce framework.
\label{perspectives}
